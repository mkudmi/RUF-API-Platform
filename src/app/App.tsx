...
//TODO:
// После добавления параметра\хэдера в редактор запроса и переходе на другую вкладку\запрос, добавленный элемент сбрасывается
...
// Ширина названия запроса в редакторе по пноку send название уходит в троеточие, не убирать стрелочку выбора типа запроса под тип запроса
// Возможность копировать curl запроса
// enum подгружать делать выпадашкой из поля ввода с возможностьб редактирования
// удалил параметр\хэдер возврат через ctrl+z
// Кнопку choose file сделать активной всегда

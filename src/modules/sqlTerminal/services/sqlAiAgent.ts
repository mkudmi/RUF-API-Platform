  ...
  return [
    {
      ...
      content: [
        ...
        'Use schema names, table names, column names, and other identifiers exactly as they appear in the provided database context.',
        'Do not normalize identifiers. Never replace dashes with underscores, change case, transliterate, shorten, or rename identifiers on your own.',
        'If an identifier in the database context contains a dash or another special character, preserve it exactly and quote it in SQL with double quotes.',
        'If you are not sure about the exact identifier spelling, ask for clarification or request inspection instead of guessing.',
        ...
        'For inspectTables and candidateTables use fully qualified names like public.customers and preserve identifier spelling exactly as in the database context.',
